...
function playRound(computerSelection, playerSelection){  // returns a string declaring the winner
...
function game(){  // plays a five-round game, returning a string declaring the winner at the end
    let userWins = 0;
    let computerWins = 0;
